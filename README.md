...
This project is fun to build especially when we validate the form values. I enjoyed validating the values with many conditions.
...
- I learnt how to validate the form values with Vanilla JavaScript.
- How we can display the error message when wrong inputs are entered in the form.
